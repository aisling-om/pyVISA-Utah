...
#Take data from mixed Chan2-3 setup
...
agilent.write(":CHANNEL4:RANGE 8.0")
agilent.write(":TRIGGER:LEVEL CHAN4, 2.0")

agilent.write(":CHANNEL1:RANGE 1.6")
#agilent.write(":TRIGGER:LEVEL CHAN1,-0.04")

agilent.write(":CHANNEL2:RANGE 1.6")
#agilent.write(":TRIGGER:LEVEL CHAN2,-0.04")

agilent.write(":CHANNEL3:RANGE 0.04")
